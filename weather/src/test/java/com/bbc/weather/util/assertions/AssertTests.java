...
public class AssertTests {
	...
	public void assertErrorWithScreenshot(String errorMessage, String screenName)
			throws Throwable {
	...
	// public void assertElementPresent(Object pageObject, WebElement
	// webElement) throws Throwable {
	// assertErrorWithScreenshot(pageObject.isElementPresent(webElement),
	// "The WebElement is not present on page. " +
	// element.getWebElementNameAndLocator(pageObject, webElement),
	// "elementNotPresent");
	// }
	//
	// public void assertElementVisible(WebElement webElement) throws Throwable
	// {
	// assertErrorWithScreenshot(element.isDisplayed(webElement),
	// "The WebElement is not visible on page. " + "\n",
	// "elementVisible");
	// }
